...
def build_prompt(query: str, context: List[str]) -> List[Dict[str, str]]:
    ...
    system = {
        ...
        "based ONLY on the provided context, and DO NOT use your knowledge from elsewhere."
        "If there is not enough information in the context to answer the question,"
        'say "I am not sure", then try to make a guess.'
        "Break your answer up into nicely readable paragraphs. Always respond in less than 300 words",
    }
    user = {
        "role": "user",
...
data_in_db = collection.peek(70)['metadatas']

src = [src["Source"] for src in data_in_db]

st.set_page_config(layout="centered")
st.title("Chat With SS1/23")
